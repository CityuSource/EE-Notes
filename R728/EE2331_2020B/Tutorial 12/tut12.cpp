...
{
	if (myDate.month < 10 || myDate.day < 10)
		if (myDate.month < 10)
			return osObject << myDate.year << "-0" << myDate.month << "-" << myDate.day;
		else if (myDate.day < 10)
			return osObject << myDate.year << "-" << myDate.month << "-0" << myDate.day;
		else
			return osObject << myDate.year << "-0" << myDate.month << "-0" << myDate.day;
	else
		return osObject << myDate.year << "-" << myDate.month << "-" << myDate.day;
}
...
{
	return osObject << "$" << myInvoice.amount << " (" << myInvoice.date << ")";
}
...
{
	invoice *a1 = (invoice *)a;
	invoice *b1 = (invoice *)b;

	if (a1->date.year == b1->date.year && a1->date.month == b1->date.month && a1->date.day == b1->date.day)
		return 0;
	if (a1->date.year < b1->date.year)
		return 1;
	if (a1->date.year == b1->date.year && a1->date.month < b1->date.month)
		return 1;
	if (a1->date.year == b1->date.year && a1->date.month == b1->date.month && a1->date.day < b1->date.day)
		return 1;
	return -1;
