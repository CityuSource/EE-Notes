...
subplot(1, 4, 2), imshow(image_salt), title('Image with salt noise');
subplot(1, 4, 3), imshow(image_cmf), title('Salt image after Contraharmonic Mean Filter');
subplot(1, 4, 4), imshow(image_minf), title('Salt image after Minimum Filter');