...
int compareInvoiceDate(const void *a, const void *b)
{
	...
	if (objA->date.year != objB->date.year)
		return objB->date.year - objA->date.year;
	else if (objA->date.month != objB->date.month)
		return objB->date.month - objA->date.month;
	return objB->date.day - objA->date.day;
}
...
int compareInvoiceAmountDate(const void *a, const void *b)
{
	...
	return -compareInvoiceDate(objA, objB);
}
