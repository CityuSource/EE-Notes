...
subplot(2, 2, 2), imshow(image_sb), title('Image after sobel filter');

%% Hough transform with largest two points
subplot(2, 2, 3), imshow(H, [], 'XData', T, 'YData', R, 'InitialMagnification', 'fit'),
...
subplot(2, 2, 4), imshow(image), title('Detected two lines');
hold on;
