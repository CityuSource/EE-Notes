...
import lab5.solution.given.Card;
...
// import static lab5.solution.Deal.rankCode;
...
public class Deal {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < numHands; i++) {
             ...
             * new Comparator<Card>() {
             * 
             * @Override public int compare(Card c1, Card c2) { if (c1.suit.equals(c2.suit))
             * { return rankCode.get(c1.rank) - rankCode.get(c2.rank); } else { return
             * suitCode.get(c2.suit) - suitCode.get(c1.suit); }
             * 
             * } };
             */
